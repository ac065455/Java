...
This class is a lexical analyzer for the 20 token categories <id> through <RBrace> defined by:
...
The DFA has 20 final and 4 non-final states represented by enum-type literals.

There are also 3 special states for the keywords "class", "if", "null".
...
public abstract class LexAnalyzer extends IO
{
	public enum State 
	  ...
	  // non-final states                 string recognized    
		...
		Start,           // 20         the empty string
		Period,          // 21         ".", "+.", "-."
		E,               // 22         float parts ending with E or e
		EPlusMinus,      // 23         float parts ending with + or - in exponentiation part
	...
	static State nextState[][] = new State[24][128];
          ...
          // the first array index from 0 through 23. 
